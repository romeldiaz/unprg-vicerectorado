...
<div class="row">
	<div class="col-2">
		...
		<div class="alert alert-warning mt-3" role="alert">
			En la lista de tu derecha son las actividades en las que estas asiganado como responsable, no las puedes elimiar ni editar.
			Puedes crear metas para esta actividad y seleccionar reponsables para que te ayuden a cumplirla!
		</div>
	</div>
	<div class="col-10">
