					...
					<div class="col-sm-12">
						<div class="form-group mb-3">
							...
							<select name="actividad_id" id="actividad_id" class="custom-select form-control form-control-sm">
								...
								@endforeach
							</select> {{-- {!!Form::select('actividad_id', ['I'=>'Iniciado', 'F'=>'Finalizado'], null, ['class'=>'custom-select
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<div class="input-group input-group-sm">
								...
								@php $now = date("Y-m-d", strtotime(now('America/Lima'))); @endphp
								{!! Form::date('fecha_inicio',$now, ['class'=>'form-control form-control-sm']) !!}
							</div>
						</div>
					</div>
					<div class="col-sm-6">
